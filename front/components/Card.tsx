...
function Card() {
  return (
    <a href="#" className="hover:scale-95 hover:shadow-2xl transition-transform duration-300 z-100">
      <div className="border border-gray-400 bg-amber-100 rounded shadow-lg p-3 w-full h-56 grid grid-cols-6 gap-4">
        ...
        <div className="col-span-4 grid grid-rows-[auto_1fr] items-center">
