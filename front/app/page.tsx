    ...
    <div className="grid grid-rows-[auto_1fr_200px] items-center justify-items-center min-h-screen md:p-8 pb-20 gap-5 font-[family-name:var(--font-geist-sans)]">
      ...
      <main className=" min-h-screen w-full row-start-2 grid grid-rows-[auto_1fr]">
        ...
        <div className="p-5">
          ...
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum itaque id reprehenderit facere tempora qui harum deleniti laudantium! Magnam voluptatibus omnis, earum modi voluptates ducimus dignissimos debitis eum expedita nulla.
          Eum dolorem minus aperiam nam consectetur eveniet laudantium saepe, officiis soluta voluptatibus modi distinctio suscipit ab libero doloribus hic dolor quia vero! Est, debitis perferendis placeat animi ducimus modi eum?</p>
        </div>
